...
function PrismPlugin(opts) {
    ...
    // Small optimization to cache the last computed tokens.
    let previousTokens;
    ...
    function decorate(text, block) {
        ...
        if (previousBlock === block) {
            ...
            blockText = block.getTexts().map(t => t.text).join('\n');
        ...
        // Find where the current text is in the whole block text.
        let characters = text.characters.asMutable();
        const textStart = blockText.indexOf(text.text);
